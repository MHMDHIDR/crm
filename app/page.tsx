...
import TestimonialsCarousel from '@/components/custom/testimonials'
    ...
    <main className='container mx-auto px-4 py-16'>
      ...
      <div className='flex flex-col lg:flex-row items-center justify-between gap-12 mb-24'>
        <div className='lg:w-1/2'>
          <h1 className='text-7xl font-extrabold gradient-title pb-6'>Simplify Your Scheduling</h1>
          <p className='text-xl text-gray-600 mb-10'>
            Schedulrr helps you manage your time effectively. Create events, set your availability,
